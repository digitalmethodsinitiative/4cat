...
class Search8Chan(SphinxSearch):
	...
	def fetch_sphinx(self, where, replacements):
		...
		"""
		sql = "SELECT thread_id, post_id FROM `posts_" + self.prefix + "` WHERE " + where + " LIMIT 5000000 OPTION ranker = none, boolean_simplify = 1, sort_method = kbuffer, cutoff = 5000000"
