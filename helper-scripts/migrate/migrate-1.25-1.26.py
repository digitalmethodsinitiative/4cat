...
if transfer_settings:
    ...
    old_settings = [
        ...
        ('YOUTUBE_API_SERVICE_NAME', getattr(old_config, "YOUTUBE_API_SERVICE_NAME", None)),
        ('YOUTUBE_API_VERSION', getattr(old_config, "YOUTUBE_API_VERSION", None)),
        ('YOUTUBE_DEVELOPER_KEY', getattr(old_config, "YOUTUBE_DEVELOPER_KEY", None)),
        ('TOOL_NAME', getattr(old_config, "TOOL_NAME", None)),
        ('TOOL_NAME_LONG', getattr(old_config, "TOOL_NAME_LONG", None)),
        ('PATH_VERSION', getattr(old_config, "PATH_VERSION", None)),
        ('GITHUB_URL', getattr(old_config, "GITHUB_URL", None)),
        ('EXPIRE_DATASETS', getattr(old_config, "EXPIRE_DATASETS", None)),
        ('EXPIRE_ALLOW_OPTOUT', getattr(old_config, "EXPIRE_ALLOW_OPTOUT", None)),
        ('WARN_INTERVAL', getattr(old_config, "WARN_INTERVAL", None)),
        ('WARN_LEVEL', getattr(old_config, "WARN_LEVEL", None)),
        ('WARN_SLACK_URL', getattr(old_config, "WARN_SLACK_URL", None)),
        ('WARN_EMAILS', getattr(old_config, "WARN_EMAILS", None)),
        ('ADMIN_EMAILS', getattr(old_config, "ADMIN_EMAILS", None)),
        ('MAILHOST', getattr(old_config, "MAILHOST", None)),
        ('MAIL_SSL', getattr(old_config, "MAIL_SSL", None)),
        ('MAIL_USERNAME', getattr(old_config, "MAIL_USERNAME", None)),
        ('MAIL_PASSWORD', getattr(old_config, "MAIL_PASSWORD", None)),
        ('NOREPLY_EMAIL', getattr(old_config, "NOREPLY_EMAIL", None)),
        ...
        ('MAX_EXPLORER_POSTS', getattr(old_config, "MAX_EXPLORER_POSTS", None)),
        ...
        ('tumblr-search.TUMBLR_CONSUMER_KEY', getattr(old_config, "TUMBLR_CONSUMER_KEY", None)),
        ('tumblr-search.TUMBLR_CONSUMER_SECRET_KEY', getattr(old_config, "TUMBLR_CONSUMER_SECRET_KEY", None)),
        ('tumblr-search.TUMBLR_API_KEY', getattr(old_config, "TUMBLR_API_KEY", None)),
        ('tumblr-search.TUMBLR_API_SECRET_KEY', getattr(old_config, "TUMBLR_API_SECRET_KEY", None)),
        ('get-reddit-votes.REDDIT_API_CLIENTID', getattr(old_config, "REDDIT_API_CLIENTID", None)),
        ('get-reddit-votes.REDDIT_API_SECRET', getattr(old_config, "REDDIT_API_SECRET", None)),
        ...
        ('FLASK_APP', getattr(old_config.FlaskConfig, "FLASK_APP", None)),
        ('SERVER_NAME', getattr(old_config.FlaskConfig, "SERVER_NAME", None)),
        ('SERVER_HTTPS', getattr(old_config.FlaskConfig, "SERVER_HTTPS", None)),
        ('HOSTNAME_WHITELIST', getattr(old_config.FlaskConfig, "HOSTNAME_WHITELIST", None)),
        ('HOSTNAME_WHITELIST_API', getattr(old_config.FlaskConfig, "HOSTNAME_WHITELIST_API", None)),
        ('HOSTNAME_WHITELIST_NAME', getattr(old_config.FlaskConfig, "HOSTNAME_WHITELIST_NAME", None)),
        ]
