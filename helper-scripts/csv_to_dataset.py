...
cli.add_argument(
    "-u", "--user", default="autologin", help="Username to assign the dataset to"
)
cli.add_argument(
    "-d", "--datasource", default="custom", help="Datasource to assign to dataset"
)
args = cli.parse_args()
