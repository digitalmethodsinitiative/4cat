...
class DailyHistogramRenderer(BasicPostProcessor):
	"""
	Generate activity histogram
	"""
	type = "daily-histogram"  # job type ID
	category = "Visual" # category
	title = "Histogram (daily)"  # title displayed in UI
	description = "Generates a histogram (bar graph) that aggregates the number of posts per day to provide an impression of over-time activity in the data set"  # description displayed in UI
