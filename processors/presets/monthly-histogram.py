...
class MonthlyHistogramCreator(ProcessorPreset):
    ...
    def get_options(cls, parent_dataset=None, user=None):
        count_options = copy.deepcopy(
            CountPosts.get_options(parent_dataset=parent_dataset, user=user)
        )
    ...
    def get_processor_pipeline(self):
        ...
        pipeline = [
            ...
            {"type": "count-posts", "parameters": {**query}},
            # then, render it
            {"type": "histogram", "parameters": {"header": header}},
        ]
