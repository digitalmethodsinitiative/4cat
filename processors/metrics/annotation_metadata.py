...
class AnnotationMetadata(BasicProcessor):
    ...
    description = (
        "Download metadata about annotations for this dataset. "
        "Includes information like annotation author, timestamp, type, etc."
    ...
    def to_date_str(epoch_timestamp) -> str:
        return datetime.strftime(
            datetime.utcfromtimestamp(int(epoch_timestamp)), "%Y-%m-%d %H:%M:%S"
        )
