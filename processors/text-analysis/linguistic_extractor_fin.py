...
class LinguisticFeatures(BasicProcessor):
	...
	"""
	type = "linguistic-features-fin"  # job type ID
	category = "Text analysis"  # category
	title = "Annotate text features with SpaCy in Finnish"  # title displayed in UI
	...
	followups = ["get-entities-fin", "extract-nouns-fin"]
