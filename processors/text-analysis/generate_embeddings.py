...
class GenerateWordEmbeddings(BasicProcessor):
    ...
    description = (
        "Generates Word2Vec or FastText word embedding models (overall or per timeframe). "
        ...
        "Note that good models require a lot of data."
    ...
    options = {
        "model-type": {
            ...
            "default": "Word2Vec",
            "options": {"Word2Vec": "Word2Vec", "FastText": "FastText"},
            "help": "Model type",
        },
        "algorithm": {
            "type": UserInput.OPTION_CHOICE,
    ...
    def process(self):
        ...
        model_builder = {"Word2Vec": Word2Vec, "FastText": FastText}[model_type]
