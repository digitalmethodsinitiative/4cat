...
class StableDiffusionImageGenerator(BasicProcessor):
    ...
    description = ProcessorDescription(
        ...
        warnings=[
            "Images are generated by a self-hosted DMI Service Manager, which must have a Stable Diffusion image built and a GPU available.",
            "Prompts are truncated to 70 characters before generation.",
        ],
        icon="images",
    )
