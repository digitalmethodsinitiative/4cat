...
class VideoDownloaderPlus(BasicProcessor):
    ...
    description = ProcessorDescription(
        ...
        description="Find video links in a column and download the videos to a zip archive. Tries a direct download first and falls back to yt-dlp, which supports YouTube and many other video hosts. Downloads only directly linked videos unless indirect links are enabled by an administrator.",
        references=[
