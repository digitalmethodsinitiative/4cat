...
class TelegramFileDownloader(TelegramVideoDownloader):
    ...
    description = ProcessorDescription(
        ...
        description="Download the audio, documents, stickers, and other non-video, non-photo file attachments of Telegram messages and store them in a ZIP file. A JSON metadata file recording the download outcome per message is included in the archive.",
        warnings=[
