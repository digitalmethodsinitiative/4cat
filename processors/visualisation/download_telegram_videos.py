...
class TelegramVideoDownloader(BasicProcessor):
    ...
    description = ProcessorDescription(
        ...
        description="Download the videos attached to Telegram messages and store them in a ZIP file. A JSON metadata file recording the download outcome per message is included in the archive.",
        warnings=[
