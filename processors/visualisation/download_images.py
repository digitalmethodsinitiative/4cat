...
class ImageDownloader(BasicProcessor):
    ...
    description = ProcessorDescription(
        ...
        description="Extract image URLs from a chosen column and download the images into a ZIP file. For Imgur galleries only the first image is saved, and for animated GIFs only the first frame. A JSON metadata file is included in the archive.",
        warnings=[
