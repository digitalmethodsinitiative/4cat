...
class ImageTextWallGenerator(BasicProcessor):
    ...
    description = ProcessorDescription(
        ...
        category="Visual",
        description="Combine downloaded images and their captions into a single wall-like SVG image. Each image is tiled and labelled with its caption text below it. Works with datasets that pair images and captions, such as generated images with prompts or images with their extracted text.",
        icon="panorama",
    )
