...
class VisionTagNetworker(BasicProcessor):
    ...
    description = ProcessorDescription(
        ...
        category="Networks",
        tags=["network"],
        description="Create a GEXF network file from annotations returned by the Google Vision API. Labels returned by the API are nodes. An edge connects two labels when they occur on the same image, weighted by how often they co-occur.",
        icon="circle-nodes",
    )
