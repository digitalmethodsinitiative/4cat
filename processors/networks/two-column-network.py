...
class ColumnNetworker(BasicProcessor):
    ...
    description = ProcessorDescription(
        ...
        category="Networks",
        tags=["network"],
        description="Create a GEXF network file of linked values between two chosen columns (for example 'author' and 'subreddit'). Nodes and edges are weighted by frequency. Optionally make the network dynamic over time and detect communities.",
        references=[
