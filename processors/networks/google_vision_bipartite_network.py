...
class VisionTagBiPartiteNetworker(BasicProcessor):
    ...
    description = ProcessorDescription(
        ...
        category="Networks",
        tags=["network"],
        description="Create a GEXF network file from annotations returned by the Google Vision API. Image file names and the labels returned for them are nodes. An edge connects a file name to a label when that label occurs for that image.",
        icon="circle-nodes",
    )
