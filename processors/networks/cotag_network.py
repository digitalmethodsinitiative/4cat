...
class CoTaggerPreset(ProcessorPreset):
    ...
    description = ProcessorDescription(
        ...
        description="Create a GEXF network file of tags co-occurring in items. Edges are weighted by how often two tags co-occur; nodes are weighted by how often a tag appears in the dataset.",
        icon="circle-nodes",
    )
    ...
    compatibility = Compatibility(requires_any_columns=possible_tag_columns)
