...
class VisionTagBiPartiteNetworker(BasicProcessor):
    ...
    description = (
        "Create a GEXF network file comprised of all annotations returned by the Clarifai API. Labels "
    ...
    def process(self):
        ...
        for annotations in self.source_dataset.iterate_items(self):
            ...
            network.add_node(
                image_id, label=annotations["image"], type="image", annotation_type=""
            )
