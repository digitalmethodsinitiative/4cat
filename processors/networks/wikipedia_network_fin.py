...
class WikiURLCoLinker(BasicProcessor):
	...
	"""
	type = "wiki-category-network-fin"  # job type ID
	category = "Networks"  # category
	title = "Wikipedia category network in Finnish"  # title displayed in UI
	description = "Create a GEXF network file comprised network comprised of linked-to Wikipedia pages, linked to the categories they are part of. Finnish Wikipedia only. Will only fetch the first 10,000 links."  # description displayed in UI
