...
class CowordNetworker(ProcessorPreset):
    ...
    description = ProcessorDescription(
        ...
        category="Networks",
        tags=["network"],
        description="Create a GEXF network file of word co-occurrences. Edges connect words that appear close to each other. Edges and nodes are weighted by how often the words co-occur.",
        icon="circle-nodes",
    )
