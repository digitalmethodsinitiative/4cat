...
class WikiURLCoLinker(BasicProcessor):
	...
	description = ProcessorDescription(
		...
		category="Networks",
		tags=["network", "urls"],
		description="Create a GEXF network file of linked-to Wikipedia pages connected to the categories they belong to. Wikipedia links are extracted from the post body and looked up through Wikipedia to find their categories.",
		warnings=[
			"Only English Wikipedia is supported, and only the first 10,000 links found are used.",
			"Page categories are fetched from Wikipedia, an external service.",
		],
		icon="circle-nodes",
	)
