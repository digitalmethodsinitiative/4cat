...
class HashSimilarityNetworker(BasicProcessor):
    ...
    description = ProcessorDescription(
        ...
        description="Compare bit hashes and create a GEXF network file linking similar items. Each pair of hashes is compared bit by bit, and an edge is added when they are at least as similar as the chosen threshold. Useful for finding near-duplicate images or videos.",
        warnings=[
