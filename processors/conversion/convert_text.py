...
class ConvertText(BasicProcessor):
    ...
    description = ProcessorDescription(
        ...
        category="Conversion",
        tags=["clean text"],
        description="Find text in selected columns, replace matching parts, and write the result to a new dataset. Matches can be plain text or a regular expression. Replaced text can also be added back to the original dataset as annotations.",
