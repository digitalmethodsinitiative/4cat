...
class TwitterStats(TwitterStatsBase):
    ...
    def map_data(self, post):
        ...
        sum_map = {
            ...
            "Total Retweets of User's Tweets (in interval)": post.get(
                "public_metrics"
            ).get("retweet_count"),
            "Total Replies of User's Tweets (in interval)": post.get(
                "public_metrics"
            ).get("reply_count"),
            "Total Likes of User's Tweets (in interval)": post.get(
                "public_metrics"
            ).get("like_count"),
            "Total Quotes of User's Tweets (in interval)": post.get(
                "public_metrics"
            ).get("quote_count"),
        }
        ...
        static_map = {
            ...
            "Number User is Following (at time of collection)": post.get("author_user")
            .get("public_metrics")
            .get("following_count"),
            "Number Followers of User (at time of collection)": post.get("author_user")
            .get("public_metrics")
            .get("followers_count"),
            "Total Number of Tweets (at time of collection)": post.get("author_user")
            .get("public_metrics")
            .get("tweet_count"),
        }
        list_map = {}
