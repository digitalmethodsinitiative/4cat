...
class TwitterCustomStats(TwitterStatsBase):
    ...
    def map_data(self, post):
        ...
        sum_map = {
            ...
            "Total Retweets of grouped Tweets (public metrics)": post.get(
                "public_metrics"
            ).get("retweet_count"),
            "Total Replies to grouped Tweets (public metrics)": post.get(
                "public_metrics"
            ).get("reply_count"),
            "Total Likes of grouped Tweets (public metrics)": post.get(
                "public_metrics"
            ).get("like_count"),
            "Total Quotes of grouped Tweets (public metrics)": post.get(
                "public_metrics"
            ).get("quote_count"),
